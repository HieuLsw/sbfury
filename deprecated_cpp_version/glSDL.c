 ...
 */
	...
	gl.Disable(GL_CULL_FACE);
        ...
        //gl.PushMatrix();
        //gl.Rotated(1, 10, 0, 0.5);
        //gl.Scalef(1.45, 1.45, 0);
        //gl.Translatef(-98, -63, 0);
        //gluLookAt(1, 1, 1, 100, 100, 0, 1, 1, 1);
        //gluPerspective(10, 0.5, 1, 1);
...
static int blit_scaled(SDL_Surface *src, SDL_Rect *srcrect,
			 SDL_Surface *dst, SDL_Rect *dstrect)
{
	glSDL_TexInfo *txi;
	SDL_Rect r;
